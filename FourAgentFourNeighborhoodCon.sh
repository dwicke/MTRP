...
mkdir /home/dwicke/tmp/fouragentCon
mkdir /home/dwicke/tmp/fouragentCon/NoFuel
...
do
    ...
    java -jar MTRP-1.0-SNAPSHOT.jar -repeat 4 -parallel 16 -for ${numIterations[i]} -ignoreJob 1 -y /home/dwicke/tmp/fouragentCon/NoFuel --numAgents 4 --numNeighborhoods ${numNeighborhood[i]} --simWidth 100 --simHeight 100 --agentType 5 --fuelCapacity 1500000 --hasRandomness true --numDepos 4 --fuelCost 0 --timestepsTilNextTask ${rate[i]} --jobLength ${jobLen[i]} --numJobTypes 1 -gl NN -ls ${numIterations[i]} -es 1
...
do
    for j in 0 1 2 3 4 5 6;
    do
        #java -jar MTRP-1.0-SNAPSHOT.jar -repeat 4 -parallel 16 -for ${numIterations[i]} -ignoreJob 1 -y /home/dwicke/tmp/fouragentCon/Fuel --numAgents 4 --numNeighborhoods ${numNeighborhood[i]} --simWidth 100 --simHeight 100 --agentType 4 --fuelCapacity 3000 --hasRandomness true --numDepos 4 --fuelCost 1.0 --timestepsTilNextTask ${rate[i]} --jobLength ${jobLen[i]} --bountyIncrement ${increment[j]} --numJobTypes 1 --hasNeighborhoodBounty true -gl NB -ls ${numIterations[i]} -es 1
        java -jar MTRP-1.0-SNAPSHOT.jar -repeat 4 -parallel 16 -for ${numIterations[i]} -ignoreJob 1 -y /home/dwicke/tmp/fouragentCon/Fuel --numAgents 4 --numNeighborhoods ${numNeighborhood[i]} --simWidth 100 --simHeight 100 --agentType 4 --fuelCapacity 3000 --hasRandomness true --numDepos 4 --fuelCost 1.0 --timestepsTilNextTask ${rate[i]} --jobLength ${jobLen[i]} --bountyIncrement ${increment[j]} --numJobTypes 1 -gl bounty -ls ${numIterations[i]} -es 1
    done
    java -jar MTRP-1.0-SNAPSHOT.jar -repeat 4 -parallel 16 -for ${numIterations[i]} -ignoreJob 1 -y /home/dwicke/tmp/fouragentCon/Fuel --numAgents 4 --numNeighborhoods ${numNeighborhood[i]} --simWidth 100 --simHeight 100 --agentType 5 --fuelCapacity 3000 --hasRandomness true --numDepos 4 --fuelCost 1.0 --timestepsTilNextTask ${rate[i]} --jobLength ${jobLen[i]} --numJobTypes 1 -gl NN -ls ${numIterations[i]} -es 1
