...
do
    ...
    java -jar MTRP-1.0-SNAPSHOT.jar -repeat 1 -parallel 8 -for ${numIterations[i]} -ignoreJob 1 -y /home/dwicke/tmp/NoFuel --numAgents 64 --numNeighborhoods ${numNeighborhood[i]} --simWidth 320 --simHeight 320 --agentType 6 --fuelCapacity 1500000 --hasRandomness true --numDepos 64 --fuelCost 0 --timestepsTilNextTask ${rate[i]} --jobLength ${jobLen[i]} --numJobTypes 1 --taskLocLength 40 -gl NN
...
do
    ...
    java -jar MTRP-1.0-SNAPSHOT.jar -repeat 1 -parallel 8 -for ${numIterations[i]} -ignoreJob 1 -y /home/dwicke/tmp/Fuel --numAgents 64 --numNeighborhoods ${numNeighborhood[i]} --simWidth 320 --simHeight 320 --agentType 6 --fuelCapacity 3000 --hasRandomness true --numDepos 64 --fuelCost 1.0 --timestepsTilNextTask ${rate[i]} --jobLength ${jobLen[i]} --numJobTypes 1 --taskLocLength 40 -gl NN
